...
class Logger():
    ...
    def save_images(self, iteration, color_image, depth_image):
        ...
        np.save(os.path.join(self.depth_images_directory, '%06d.depthdepth.npy' % iteration), depth_image)
        cv2.imwrite(os.path.join(self.depth_images_directory, '%06d.depthdepth.png' % iteration), depth_image)
        ...
        np.save(os.path.join(self.depth_images_directory, '%06d.depth.npy' % iteration), depth_image)
